...
song_dict=dict(filter(lambda x : x[1]>1,song_dict.items()))
...
class AE(nn.Module):
    def __init__(self,original_dim):
        ...
        self.fc1=nn.Linear(original_dim,16384)
        self.fc2=nn.Linear(16384,8192).cuda()
        #self.fc3=nn.Linear(4096,2048).cuda()
        #self.fc4=nn.Linear(2048,4096).cuda()
        self.fc5=nn.Linear(8192,16384).cuda()
        self.fc6=nn.Linear(16384,original_dim).cpu()
